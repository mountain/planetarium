            ...
            if keystr in self.list_input:
                ...
                if len(self.layout_input) == 5:
                    ...
                    if np.isscalar(val):
                        ...
                        if len(val.shape) < len(self.layout_in):
                            value = val[:, np.newaxis, np.newaxis] * np.ones(self.layout_in)
                        else:
                            value = val
            ...
            if keystr in self.list_output:
                ...
                if len(self.layout_output) == 5:
                    ...
                    if np.isscalar(val):
                        ...
                        if len(val.shape) < len(self.layout_out):
                            value = val[:, np.newaxis, np.newaxis] * np.ones(self.layout_out)
                        else:
                            value = val
